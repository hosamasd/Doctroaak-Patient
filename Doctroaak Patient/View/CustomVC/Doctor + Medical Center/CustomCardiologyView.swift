...
class CustomCardiologyView: CustomBaseView {
    ...
    override func setupViews() {
        ...
        addSubViews(views: LogoImage,backImage,notifyImage,titleLabel,soonLabel,cardiologyCollectionVC.view)
        ...
        cardiologyCollectionVC.view.anchor(top: soonLabel.bottomAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor,padding: .init(top: 64, left: 32, bottom: 16, right: 32))
    }
}
